<template>
  <v-data-table :headers="headers" :items="cordinators" class="elevation-1">
    <template v-slot:top>
      <v-toolbar flat>
        ...
        <v-dialog v-model="dialogDelete" max-width="500px">
          <v-card>
            <v-card-title class="headline"
              >¿Estas seguro que quieres eliminar el coordinador?</v-card-title
            >
            <v-card-actions>
              <v-spacer></v-spacer>
...
export default {
  ...
  data: () => ({
    ...
    items: ["Carrera Tecnica", "Licenciatura", "Maestria", "Doctorado"],
    cordinators: [],
    editedIndex: -1,
    editedItem: {
      name: "",
